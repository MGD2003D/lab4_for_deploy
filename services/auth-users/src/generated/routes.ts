...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsUsersController_searchUser: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"query","name":"id","dataType":"double"},
                email: {"in":"query","name":"email","dataType":"string"},
        };
        app.get('/users/search/by',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.searchUser)),

            async function UsersController_searchUser(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsFollowController_createFollow: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.post('/follows',
            ...
            ...(fetchMiddlewares<RequestHandler>(FollowController.prototype.createFollow)),

            async function FollowController_createFollow(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsFollowController_deleteFollow: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.delete('/follows',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(FollowController)),
            ...(fetchMiddlewares<RequestHandler>(FollowController.prototype.deleteFollow)),

            async function FollowController_deleteFollow(request: ExRequest, response: ExResponse, next: any) {
